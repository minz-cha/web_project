		...
		<div style="width: 70%;">
			...
			<div style="width: 80%">
				<div class="form-floating">
					<div
						style="border: 1px dotted; border-radius: 5px; padding: 10px; height: 100px; font-size: 25px">공지사항1</div>
				</div>
				<div class="form-floating">
					<div
						style="border: 1px dotted; border-radius: 5px; padding: 10px; height: 500px;">공지사항1</div>
